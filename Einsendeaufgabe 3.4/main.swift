...
print("Dies ist ein einfacher Taschenrechner, welcher Ganzzahlen berechnet über + - / *. \nBitte geben Sie zunächst den 1. Wert, dann den 2. Wert und schließlich die Operation an. Die Operation kann über die gängigen Zeichen + - / * und auch über die Zahlen von 1 - 4 eingegeben werden.")
